var consoleElement = document.getElementById("console"),
    ...
    messages = {
      ...
      "about": ""
    };
...
function executeCommand(command) {
  ...
  switch (cmd) {
    ...
    case "goto":
      if (args[0] == null) {
        addText("Usage: goto <full url including http/https>\n");
      } else {
    ...
    case "play":
      if (args[0] == null) {
        ...
        if (match && match[2].length == 11) {
          videoId = match[2];
          youtubePlayer.innerHTML = '<iframe width="426" height="240" src="https://www.youtube.com/embed/' + videoId + '?autoplay=1" frameborder="0" allowfullscreen></iframe>';
